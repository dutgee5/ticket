...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native ticket initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this ticket : https://thecodingmachine.github.io/react-native-ticket/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-ticket/issues'
			);
			console.log(
				'- ⭐ If you love this ticket, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-ticket'
			);
